      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-balance">
            Unlock Your Soulmate for Just{" "}
            <span className="text-primary">₹39</span>
          </h2>
          <p className="text-muted-foreground text-lg">
            No subscriptions. No hidden fees. Pay only when you find someone
            special.
          </p>
        </div>

        {/* Pricing + Comparison (single row on desktop) */}
        <div className="grid items-start gap-10 lg:grid-cols-[420px_1fr]">
            ...
            <Card className="relative overflow-hidden border-2 border-primary shadow-xl">
              ...
              <CardContent className="pt-6">
                ...
                <p className="text-center text-sm text-muted-foreground mt-4">
                  Registration is 100% free. Pay only to unlock contacts. <br />{" "}
                  &nbsp;
                </p>
              </CardContent>
            </Card>
          ...
          <div className="w-full">
            <h3 className="text-xl font-semibold text-center lg:text-left mb-6">
              How We Compare
            </h3>
